...
public class AppSys {
    ...
    public static final String NOTI_TYPE_DOCUMENT_RENEWAL_DELIVERED = "DOCUMENT_RENEWAL_DELIVERED";
    public static final String NOTI_TYPE_DOCUMENT_INSPECTION_RESULT = "DOCUMENT_INSPECTION_RESULT";
    public static final String NOTI_TYPE_DOCUMENT_PENDING_DEPARTMENT_PICKUP = "DOCUMENT_PENDING_DEPARTMENT_PICKUP";
    public static final String NOTI_TYPE_DOCUMENT_DELIVERY_STARTED = "DOCUMENT_DELIVERY_STARTED";
    public static final String NOTI_TYPE_DOCUMENT_REQUEST_CORRECTION_REQUIRED = "DOCUMENT_REQUEST_CORRECTION_REQUIRED";
    public static final String NOTI_TYPE_DOCUMENT_REQUEST_CANCELLED = "DOCUMENT_REQUEST_CANCELLED";

...
ENV_FILE="${ENV_FILE:-/home/ssmuser/apps/config/bos-api/prod/.env}"
FIREBASE_FILE="${FIREBASE_FILE:-/home/ssmuser/apps/config/bos-api/prod/smart-seaman-firebase.json}"

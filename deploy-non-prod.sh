...
APP_NAME="${APP_NAME:-smart-seaman-boi-api}"
IMAGE_NAME="${IMAGE_NAME:-smart-seaman-bos-api:latest}"
HOST_PORT="${HOST_PORT:-20000}"
CONTAINER_PORT="${CONTAINER_PORT:-8080}"

ENV_FILE="${ENV_FILE:-/home/ssmuser/apps/config/bos-api/non-prod/.env}"
FIREBASE_FILE="${FIREBASE_FILE:-/home/ssmuser/apps/config/bos-api/non-prod/smart-seaman-firebase.json}"
LOG_DIR="${LOG_DIR:-/home/ssmuser/apps/logs/bos-api}"
...
log "Deployment bos-api completed"
